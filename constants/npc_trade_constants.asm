...
; NPCTrades indexes (see data/events/npc_trades.asm)
	const_def
	const NPC_TRADE_JOHN   ; 0
	const NPC_TRADE_BLAKE  ; 1
	const NPC_TRADE_JACK   ; 2
	const NPC_TRADE_KIRA   ; 3
	const NPC_TRADE_GREG   ; 4
	const NPC_TRADE_EILEEN ; 5
