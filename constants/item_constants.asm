...
PARK_BALL EQU $b1            ; SOFT_PILLOW
TM_DYNAMICPUNCH_GOLD EQU $bf ; DOME_FOSSIL
TM_ZAP_CANNON_GOLD EQU $c6   ; ITEM_C6
TM_ROCK_SMASH_GOLD EQU $c7   ; ITEM_C7
