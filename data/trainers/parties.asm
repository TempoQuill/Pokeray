...
PryceGroup:
	...
	trainim 28, APPUCK,    ROYAL_ROCK,  DIG, DOUBLE_KICK, ROLLING_KICK, LEER
	trainim 27, RHYHORN,   SOFT_SAND,   DIG, HORN_ATTACK, TAIL_WHIP, STOMP
	db -1 ; end
...
JasmineGroup:
	...
	trainim 32, CHARMELEON, CHARCOAL,     SUNNY_DAY, FUNNY_STUFF, SMOKESCREEN, FLAMETHROWER
	trainim 33, QUILAVA,    CHARCOAL,     SUNNY_DAY, QUICK_ATTACK, SMOKESCREEN, FLAME_WHEEL
