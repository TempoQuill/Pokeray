...
FalknerGroup:
	...
	trainim 10, SEWMA,     FRIDGE,       PSYCHIC_M, JUMP_KICK, FALSE_SWIPE, REST
	db -1 ; end
...
WhitneyGroup:
	...
	trainim 14, BELLSPROUT, MIRACLE_SEED, VINE_WHIP, GROWTH, WRAP, GIGA_DRAIN
	trainim 16, SUNKERN,    LEFTOVERS,    FUNNY_STUFF, ABSORB, GROWTH, MEGA_DRAIN
	trainim 13, BURGELA,    SCOPE_LENS,   CONFUSION, VINE_WHIP, POISONPOWDER, SWAGGER
	db -1 ; end
...
BugsyGroup:
	...
	; ZACH
	; with Super Potion and Full Heal
	db "ZACH@", TRAINERTYPE_ITEM_MOVES
	trainim 19, EKANS,    DARKGLASSES,  SLUDGE_BOMB, BITE, POISON_STING, WRAP
	trainim 17, SMUJJ,    POISON_BARB,  SLUDGE_BOMB, SLUDGE, POISON_GAS, DISABLE
	trainim 18, KOFFING,  FILLINGBERRY, SLUDGE_BOMB, SMOG, TACKLE, POISON_GAS
	trainim 20, SPINARAK, SILVERPOWDER, SLUDGE_BOMB, LEECH_LIFE, SPIDER_WEB, NIGHT_SHADE
	db -1 ; end
...
PryceGroup:
	...
	; WOODY
	; with Hyper Potion and Dire Hit
	db "WOODY@", TRAINERTYPE_ITEM_MOVES
	trainim 26, SANDSLASH, SPICY_BERRY, DIG, SLASH, POISON_STING, SAND_ATTACK
	trainim 31, ONIX,      HARD_STONE,  DIG, RAGE, SCREECH, ROCK_THROW
	trainim 30, MAROWAK,   THICK_CLUB,  DIG, FOCUS_ENERGY, LEER, HEADBUTT
	trainim 29, QUAGAMI,   SCOPE_LENS,  DIG, WATER_GUN, AMNESIA, SLAM
	trainim 28, APPUCK,    ROYAL_ROCK,  DIG, DOUBLE_KICK, ROCK_THROW, LEER
	trainim 27, DRYTHON,   SOFT_SAND,   DIG, WRAP, BITE, POISON_STING
	db -1 ; end
...
JasmineGroup:
	...
	trainim 32, HOUNDREAD,  CHARCOAL,     SUNNY_DAY, FIRE_BLAST, FAINT_ATTACK, SMOG
	trainim 33, TODBRUSH,   SOFT_SAND,    SUNNY_DAY, CRUNCH, DIG, FLAMETHROWER
	trainim 37, ARCANINE,   BLACKGLASSES, SUNNY_DAY, QUICK_ATTACK, BITE, FLAMETHROWER
	trainim 36, NINETALES,  FURNACE,      SUNNY_DAY, EXTREMESPEED, SCREECH, FLAMETHROWER
	trainim 35, PONYTA,     SCOPE_LENS,   SUNNY_DAY, TAIL_WHIP, STOMP, EMBER
	trainim 34, BOMOCA,     MYSTIC_WATER, SUNNY_DAY, SMOG, FLAME_WHEEL, WATER_GUN
	db -1 ; end
