...
MapGroup_Cottage:
	...
	map Route49, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_49, MUSIC_ROUTE_49, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route49House, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_49, MUSIC_HOUSE_ENROUTE, FALSE, PALETTE_INDOORS, FISHGROUP_SHORE
	...
	map Route4950Gate, TILESET_FACILITY, GATE, LANDMARK_ROUTE_49, MUSIC_ROUTE_49, FALSE, PALETTE_INDOORS, FISHGROUP_SHORE
	map Route49VacuumGate, TILESET_FACILITY, GATE, LANDMARK_MT_VACUUM_BASE, MUSIC_ROUTE_49, FALSE, PALETTE_INDOORS, FISHGROUP_SHORE
	map Route4951Gate, TILESET_FACILITY, GATE, LANDMARK_ROUTE_49, MUSIC_ROUTE_49, FALSE, PALETTE_INDOORS, FISHGROUP_SHORE
	map CottageRoute55Gate, TILESET_FACILITY, GATE, LANDMARK_ROUTE_55, MUSIC_ROUTE_55, FALSE, PALETTE_INDOORS, FISHGROUP_SHORE

MapGroup_Traversal:
	map Route50, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_50, MUSIC_ROUTE_49, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Foliage:
	map Route51, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_51, MUSIC_ROUTE_49, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FoliageCity, TILESET_JOHTO, TOWN, LANDMARK_FOLIAGE_CITY, MUSIC_TRAVERSAL_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE

MapGroup_Dungeons:
	map MtVacuum, TILESET_CAVE, CAVE, LANDMARK_MT_VACUUM_BASE, MUSIC_MT_VACUUM, FALSE, PALETTE_NIGHT, FISHGROUP_SHORE

MapGroup_PortiteBayArea:
	map Route52, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_52, MUSIC_ROUTE_53, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route53, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_53, MUSIC_ROUTE_53, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PortiteCity, TILESET_JOHTO_MODERN, TOWN, LANDMARK_PORTITE_CITY, MUSIC_PORTITE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route54, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_54, MUSIC_ROUTE_53, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TeamHavocVillage, TILESET_JOHTO_MODERN, TOWN, LANDMARK_UNKNOWN, MUSIC_ROUTE_53, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
