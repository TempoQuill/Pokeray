...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_NEWBIE,    MANKEY,     LAROON,     "CARVE@@@@@@", $ce, $e6, BUDDING_SEED, 13538, "KIRA@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_SCIENTIST, PARABUD,    LARVITAR,   "DANA@@@@@@@", $ea, $cd, SOFT_SAND,    16253, "GREG@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_NEWBIE,    POUCHENT,   NOCTOWL,    "SOARIN@@@@@", $a8, $49, TWISTEDSPOON, 51886, "EILEEN@@@@@", TRADE_GENDER_EITHER
