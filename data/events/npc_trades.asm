...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_NEWBIE,    MANKEY,     LAROON,     "CARVE@@@@@@", $7e, $e6, BUDDING_SEED, 13538, "KIRA@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_SCIENTIST, PARABUD,    LARVITAR,   "SINCLAIR@@@", $ea, $cd, SOFT_SAND,    16253, "GREG@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_NEWBIE,    POUCHENT,   STAFFBIRD,  "SOARIN@@@@@", $a8, $49, SHARP_BEAK,   51886, "EILEEN@@@@@", TRADE_GENDER_EITHER
