...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	dw BaseSporeDescription
	dw BitterBiteDescription
	dw FunnyStuffDescription
...
CometPunchDescription:
	db   "Hits with 2-5 con-"
	next "secutive punches.@"
...
PayDayDescription:
	db   "Throws collectable"
	next "money for the end.@"
...
FlyDescription:
	db   "Used to head city-"
	next "bound with ease.@"
...
SlamDescription:
	db   "Impact attack via"
	next "a limb or tail.@"

VineWhipDescription:
	db   "Cracks at the foe"
	next "with thin vines.@"
...
HyperFangDescription:
	db   "An attack the foe"
	next "may flinch from.@"
...
HeadbuttDescription:
	db   "An impact that may"
	next "reel on the foe.@"
...
TwineedleDescription:
	db   "2 jabs on the foe,"
	next "can be poisonous.@"
...
NightShadeDescription:
	db   "User's level is the"
	next "damage dealt.@"

StrengthDescription:
	db   "Removes obstacles"
	next "for the trainer.@"
...
FutureSightDescription:
	db   "An attack that's"
	next "delayed 3 turns.@"

BeatUpDescription:
	db   "Party #MON join"
	next "in the attack.@"

BaseSporeDescription:
	db   "Spits out a base"
	next "to burn the foe.@"

BitterBiteDescription:
	db   "A chilly bite that"
	next "freezes the foe.@"

FunnyStuffDescription:
	db   "An attack with"
	next "random effects.@"
