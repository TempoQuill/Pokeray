...
;	line "CLUB TIME CAPSULE."
	text "Welcome to the 2nd"
	line "edition CABLE CLUB"
	cont "TIME CAPSULE."

	para "Now you can travel"
	line "farther back in"
...
Text_RejectMonWithMail:
	text "Your @"
	text_ram wStringBuffer1
	line "has MAIL that's too"
	cont "new to trade with."

	para "The message will"
	line "become lost in the"
	cont "traveling process."
	prompt
