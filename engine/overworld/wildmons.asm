...
; Morning in Equinto music doubles encounter rate.
; Best Friends Lullaby halves encounter rate.
	ld a, [wMapMusic]
	cp MUSIC_MORNING_IN_EQUINTO_MARCH
	jr z, .double
	cp MUSIC_BEST_FRIENDS_LULLABY
	ret nz
	srl b
	ret
